...
from Ques1.src.dataio import CHANNELS
from Ques1.src.preprocess import TIME,P300,mad
from Ques1.src.inference import weighted_mean,waveform_metrics,group_erp
from Ques1.src.plotting import axes_grid,save,COLORS
...
def supplement(records,out):
    ...
    for project in [1,2]:
        ...
        save(fig,out/f"project{project}_descriptive_fits")
