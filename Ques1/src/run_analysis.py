"""Run all question-one analyses on the remote GPU workstation."""
...
import numpy as np
import pandas as pd
from dataio import explore,CHANNELS
from preprocess import prepare,injection_check,TIME,BASE,P300,filter_record,epochs,baseline
from inference import choose_device,group_erp,bootstrap,waveform_metrics,cohen_d,fit_erp,weighted_mean
...
def main():
    ...
    start=time.time(); device,hardware=choose_device()
